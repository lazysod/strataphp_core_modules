                    ...
                    <tbody>
                        <?php foreach ($validationResults as $moduleName => $result) : ?>
                            <tr>
                                ...
                                <td>
                                    <?php
                                    $structureValid = !empty($result['structure']) ? array_reduce($result['structure'], function ($carry, $item) {
                                        return $carry && $item;
                                    }, true) : false;
                                    ?>
                                ...
                                <td>
                                    <?php
                                    $securityValid = !empty($result['security']) ? array_reduce($result['security'], function ($carry, $item) {
                                        return $carry && $item;
                                    }, true) : false;
                                    ?>
                                ...
                                <td>
                                    <?php
                                    $qualityValid = !empty($result['quality']) ? array_reduce($result['quality'], function ($carry, $item) {
                                        return $carry && $item;
                                    }, true) : false;
                                    ?>
                                    <?php if ($qualityValid) : ?>
                                ...
                                <td>
                                    <?php
                                    $performanceValid = !empty($result['performance']) ? array_reduce($result['performance'], function ($carry, $item) {
                                        return $carry && $item;
                                    }, true) : false;
                                    ?>
            ...
            <div class="card-body">
                <?php foreach ($modulesWithIssues as $moduleName => $result) : ?>
                    <div class="border rounded p-3 mb-3">
                        ...
                        <div class="row">
                            <?php if (!empty($result['structure']) && !array_reduce($result['structure'], function ($carry, $item) {
    return $carry && $item;
                            }, true)) : ?>
                                <div class="col-md-6">
                            ...
                            <?php if (!empty($result['security']) && !array_reduce($result['security'], function ($carry, $item) {
    return $carry && $item;
                            }, true)) : ?>
                                <div class="col-md-6">
